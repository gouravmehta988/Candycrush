class GameOvrScene extends Phaser.Scene{
    constructor(){
        super("GameOvrScene");
    }
    preload(){
        ...
        this.load.audio('gameovr', './assets/sounds/gameovr1.mp3');
    ...
    create(){
        ...
        this.sound.add('gameovr', { loop: false }).play();
     ...
     //add 1st star
     this.add.image(290, 250, "ovrstar");
     //add 2nd star
     this.add.image(360, 250, "ovrstar");
     //add 3rd star
     this.add.image(430, 250, "ovrstar");

    //add fish
    this.add.image(360, 420, "ovrfish").setScale(1.2);

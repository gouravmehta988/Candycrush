class Lvl1Scene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('lvl1', './assets/lvl1icon.png');
    this.load.image('lvlbg', './assets/lvlbg.png');
    this.load.image('lvl1iconbg', './assets/lvl1iconbg.png');
  ...
  create() {
    ...
    let timerText = this.add.text(130, 130, 'Time: ' + timeRemaining, { font: '35px bold', fontFamily: 'font1', fill: 'white' });
    ...
    this.time.delayedCall(timeRemaining * 1000, () => {
      if (score >= scoreTarget) {
        ...
        this.time.delayedCall(1000, () => {
          bgMusic.stop();
          this.scene.stop('Lvl1Scene');
          this.scene.start('Lvl2Scene');  // Move scene transition inside delay
        });
        ...
        this.time.delayedCall(2000, () => {
          bgMusic.stop();
          this.scene.start('GameOvrScene', { score: score });
        });
      }
    }, [], this);
    ...
    this.add.text(130, 75, 'Level 1', { font: '40px bold font1', fill: 'white' }).setDepth(3);
    ...
    // Splash screens.
    let splash = this.add.image(360, 540, 'lvl1').setDepth(10);
